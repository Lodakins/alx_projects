...
const handlerWrapperArgs = { functionName: 'serverless-udagram-dev-SendUploadNotifications', timeout: 6 };

try {
  const userHandler = require('./src/functions/sendNotifications/handler.js');
